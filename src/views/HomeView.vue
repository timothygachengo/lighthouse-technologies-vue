<template>
    <div v-cloak class="home">
        <div class="carousel">
            <Splide :options="{ rewind: true, arrows: false, autoplay: true, speed: 3 }" aria-label="My Favorite Images">
                <SplideSlide class="banner-images-container" v-for="image in bannerImages" :key="image">
        ...
        <div class="home-container bottom-wrap">
            <div class="login">
                <div class="login-left">
                    <img class="login-left-img" src="@/assets/images/ho_my1@3x.png" alt="user" />
            ...
            <div class="game-swiper">
                <div class="sidebar">
                    <div class="nav-item live" @click="() => setCategory('live')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'live'" class="nav-img" src="@/assets/images/ho_li1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_li2@3x.png" alt="live"/>
                        </div>
                    </div>

                    <div class="nav-item" v-on:click="() => setCategory('sport')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'sport'" class="nav-img active-img" src="@/assets/images/ho_sp1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_sp2@3x.png" alt="live"/>
                        </div>
                    </div>

                    <div class="nav-item" @click="() => setCategory('lottery')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'lottery'" class="nav-img" src="@/assets/images/ho_lo1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_lo2@3x.png" alt="live"/>
                        </div>
                    </div>

                    <div class="nav-item" @click="() => setCategory('teenpatti')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'teenpatti'" class="nav-img" src="@/assets/images/ho_tp1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_tp2@3x.png" alt="live"/>
                        </div>
                    </div>

                    <div class="nav-item" @click="() => setCategory('poker')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'poker'" class="nav-img active-img" src="@/assets/images/ho_po1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_po2@3x.png" alt="live"/>
                        </div>
                    </div>

                    <div class="nav-item" @click="() => setCategory('slot')">
                        <div class="nav-item-img">
                            <img v-if="currentCategory === 'slot'" class="nav-img active-img" src="@/assets/images/ho_st1@3x.png" alt="live"/>
                            <img v-else class="nav-img" src="@/assets/images/ho_st2@3x.png" alt="live"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="game-brands">
                    <div class="game-brand-category">
                        <button class="game-brand" v-for="brand in currentGameBrandList" v-bind:key="brand.id">
...
export default defineComponent({
    ...
    setup() {
      ...
      const currentCategory = ref("live");
      ...
      const getInitialGameBrands = gameBrandImages.filter((gameBrand) => gameBrand.category === currentCategory.value);
      
      const currentGameBrandList = ref(getInitialGameBrands);

      const setCategory = (category:string) => {
        currentCategory.value = category;
        currentGameBrandList.value = gameBrandImages.filter((gameBrand) => gameBrand.category === category);
      }
